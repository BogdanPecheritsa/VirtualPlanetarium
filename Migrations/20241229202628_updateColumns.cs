    ...
    public partial class updateColumns : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CometID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ObjectID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CometName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ObjectID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GalaxyName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NebulaID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ObjectID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NebulaeName = table.Column<string>(type: "nvarchar(max)", nullable: false),
